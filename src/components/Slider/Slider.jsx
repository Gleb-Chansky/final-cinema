  ...
  return (
    ...
    >
      <div className="slider__wrapper">
        <div className="slider__items comedy">
          {genre.map((el, index) => {
            return (
              <div className="slider__item">
                <Link className="slider__item-inner" to={`/movie/${el.title}`}>
                  <img
      ...
      <button className="slider__control" data-slide="prev"></button>
      <button className="slider__control" data-slide="next"></button>
...
class ItcSlider {
  ...
  static createInstances() {
    if (document.querySelectorAll('[data-slider="itc-slider"]').length == 0) {
      return;
    } else {
